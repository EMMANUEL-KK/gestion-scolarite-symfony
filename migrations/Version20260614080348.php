 ...
 */
final class Version20260614080348 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE filiere (id INT AUTO_INCREMENT NOT NULL, codef VARCHAR(10) NOT NULL, intitulef VARCHAR(200) NOT NULL, UNIQUE INDEX UNIQ_2ED05D9E887025A6 (codef), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
